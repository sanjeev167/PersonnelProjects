...
<section class="content-header">
	<h1>Create administrative user account</h1>
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
		<li class="active">Administrative User</li>
	</ol>
</section>
...
<script src="${contextPath}/resources/assets/pageSpecific/js/appAdminUser.js"></script>
