					...
					<div class="box-body">
						...
						<div class="form-group">
							<label for="inputDepartmentName" class="col-sm-4 control-label">
								App. Context</label>
							<div class="col-sm-7">
								<select class="form-control" name="departmentId" id="departmentNameId" >
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" name="moduleName"
									id="moduleNameId" placeholder="Module Name">
...
<script src="${contextPath}/resources/assets/pageSpecific/js/module.js"></script>
