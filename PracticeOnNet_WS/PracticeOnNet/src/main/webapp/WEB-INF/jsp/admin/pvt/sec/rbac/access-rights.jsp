...
<section class="content container-fluid" >
	<div class="row container3Div" style="padding-bottom: 5px;">
		...
		<div class="col-md-4" style="padding-right: 0px;">
			<div class="box box-primary item" id="selectRolePageId" style="display: none;">
				<div class="box-header with-border">
		...
		<div class="col-md-3">
			<div class="box box-primary item" id="selectOpPageId" style="display: none;">
				<div class="box-header with-border">
