					...
					<div class="box-body">
						...
						<div class="form-group">
							<label for="inputCountryName" class="col-sm-4 control-label">
								Country Name</label>
							<div class="col-sm-7">
								<select class="form-control" name="countryId" id="countryNameId" >
									<option value="">-- Select --</option>	
																	
								</select>
								 <span id="countryNameId_err" class="field-error"></span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" name="stateName"
									id="stateNameId" placeholder="State Name">
								<span id="stateNameId_err" class="field-error"></span>
							</div>
						</div>
						
						<input hidden="true" name="id" id="stateRecordId" />
					</div>
					<!-- /.box-body -->
...
<script src="${contextPath}/resources/assets/pageSpecific/js/state.js"></script>
