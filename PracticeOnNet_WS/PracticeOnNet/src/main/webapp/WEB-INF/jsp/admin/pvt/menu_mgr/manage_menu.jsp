...
<section class="content container-fluid">
	<div class="row container2Div" style="padding-bottom: 5px;">
		<div class="col-md-8 item" id="changeGridWidthId" style="padding-right: 0px;">
			<div class="box box-primary ">
		...
		<div class="col-md-4 item" style="display: block;" id="vOrientationId" style="padding-right: 0px;">
			<div class="box box-primary ">
				<div class="box-header with-border">
				...
				<div class="box-body ">
					<aside class="main-sidebar "
						...
						<section class="sidebar menu-open">
							<span id="specificTreeMenuId"></span>
						</section>
					</aside>
					<!-- /.box-body -->
				</div>
						...
						<div class="form-group" id="nodeTypeLabelId"
							...
							<div class="col-sm-7">
								<input type="radio" id="nodeTypeId" class="nodeType"
									name="nodeType" checked value="N">&nbsp;&nbsp;Node
...
<script
	src="${contextPath}/resources/assets/pageSpecific/js/manageMenuTree.js"
