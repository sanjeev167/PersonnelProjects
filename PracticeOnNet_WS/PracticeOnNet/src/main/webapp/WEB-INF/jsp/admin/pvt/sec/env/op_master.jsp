...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Record Operation</li>
	</ol>
</section>
<!-- Main content -->
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" id="commonFormId" action="">
					<div class="box-body">
						...
						<div class="form-group" id="opNameLabledId">
							<label for="inputOpName" class="col-sm-4 control-label">
								Operation</label>
							<div class="col-sm-7">
								<input type="text" class="form-control" name="opName"
									id="opNameId" placeholder="Operation name">
								<span id="opName_err" class="field-error"></span>
							</div>
						</div>						
												
						<div class="form-group" id="opUrlLabledId">
							<label for="inputopUrl" class="col-sm-4 control-label">
								Op Url</label>
							<div class="col-sm-7">
								<input type="text" class="form-control" name="opUrl"
									id="opUrlId" placeholder="Base Url">
								<span id="opUrl_err" class="field-error"></span>
							</div>
						</div>						
						<input hidden="true" name="id" id="opRecordId" />
					</div>
					<!-- /.box-body -->
					<!-- /.box-footer -->
				</form>
...
<script src="${contextPath}/resources/assets/pageSpecific/js/operation.js"></script>
