...
<body class="hold-transition login-page" >
	<div class="login-box" style="margin-top: 5px;" >
		...
		<div class="login-box-body">
			...
			<!-- <div>Switch to
			  <a href="/pub/admin/login">Admin User</a>&nbsp;&nbsp;
			  <a href="/pub/user/login">Regular User</a>&nbsp;&nbsp;
			  <a href="/restricted/pub/login">Restricted User</a>
			</div> -->
			<p class="login-box-msg">Sign in to start your session. [ <b style=" font-size: small;">Web User</b> ]</p>
            ...
            <div class="social-auth-links text-center">
				<p>- OR -</p>
				<a href="/user/pub/loginf/" class="btn btn-block btn-social btn-facebook btn-flat"><i
					class="fa fa-facebook"></i> Sign in using Facebook</a> <a href="/user/pub/logingg/"
			...
			<a href="/user/pub/fgotpwd">I forgot my password</a>
			<br> 
			<a href="/user/pub/register"	class="text-center">Register a new membership</a>
