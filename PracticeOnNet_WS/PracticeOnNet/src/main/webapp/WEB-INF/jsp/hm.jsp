			...
			<div class="container">
				...
				<section class="content">
					...
					<div class="row">
						<div class="col-md-3">
							<!-- DIRECT CHAT PRIMARY -->
							<jsp:include page="hm/includes/adminDbHm.jsp" />
						...
						<div class="col-md-3">
							<!-- DIRECT CHAT SUCCESS -->
							<jsp:include page="hm/includes/userDbHm.jsp" />
						...
						<div class="col-md-3">
							<!-- DIRECT CHAT WARNING -->
							<jsp:include page="hm/includes/guestDbHm.jsp" />
						...
						<div class="col-md-3">
							<!-- DIRECT CHAT DANGER -->
							<jsp:include page="hm/includes/restrictedUserDbHm.jsp" />
