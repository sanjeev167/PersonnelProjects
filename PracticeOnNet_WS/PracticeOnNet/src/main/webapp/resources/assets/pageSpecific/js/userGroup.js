...
function reloadGrid() {
	...
	window.location.replace("/admin/pvt/sec/rbac/groupToUser/");
}
...
var baseUrl = '/admin/pvt/sec/rbac/groupToUser';
...
function loadGroupCombo(id,selectedId){	
	...
	/* stop form from submitting normally */	
	method = 'GET';
	url = "/admin/pvt/sec/rbac/group" + "/list?id=" + id;	
	//alert("url = "+url);
	$
	.ajax({
		type : method,
...
function loadCategoryCombo(id,selectedId){
	...
	/* stop form from submitting normally */	
	method = 'GET';
	url = "/admin/pvt/sec/rbac/userCategory" + "/list?id=" + id;	
	//alert("url = "+url);
	$
	.ajax({
		type : method,
...
function loadUserCombo(id,selectedId){		
	/* stop form from submitting normally */	
	method = 'GET';
	url = "/admin/pvt/sec/rbac/appAdminUser" + "/list?id=" + id;
	$.ajax({
		type : method,
		url : url,
		data : {},
