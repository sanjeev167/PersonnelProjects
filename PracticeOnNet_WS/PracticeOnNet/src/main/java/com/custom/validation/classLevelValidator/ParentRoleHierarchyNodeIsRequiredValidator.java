			...
			try {
				...
				if (parentIdValue.equals("")) { // Working
					...
					if (existingNoneNodeChildCount == 0) {// Working
						System.out.println("Add case: Tree Root node has not been created. Let it be created.");
						isValid = true;
					}
					if (existingNoneNodeChildCount == 1) {
						if (idValue == null) {// Working
							System.out.println("Add case: Tree Root node has already been created.Restrict it.");
						...
						if (idValue != null) {
							if (topNodeId == Integer.parseInt(idValue)) {// Working
								...
								System.out.println("Edit case but; Tree Root node is coming. Let it edit.");
							} else {// Working
								System.out.println("Edit case but Tree Root node is not coming.restrict it.");
