...
import com.JsonResponse.ApiErrorsView;
import com.JsonResponse.ApiFieldError;
import com.JsonResponse.ApiGlobalError;
import com.admin.pvt.masters.ctrl.CountryMasterController;
...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		System.out.println("Rhrough Advice: handleMethodArgumentNotValid");
	...
	protected ResponseEntity<Object> handleBindException(BindException ex, HttpHeaders headers, HttpStatus status,
		...
		System.out.println("Rhrough Advice: handleBindException");
		// Set the field level error with all its details
		List<ApiFieldError> apiFieldErrorList = new ArrayList<ApiFieldError>();
		ApiFieldError apiFieldError;
		for (FieldError error : ex.getBindingResult().getFieldErrors()) {
	...
	protected ResponseEntity<Object> handleTypeMismatch(final TypeMismatchException ex, final HttpHeaders headers,
		...
		logger.info(ex.getClass().getName());
		System.out.println("Rhrough Advice: handleTypeMismatch");
		//
	...
	protected ResponseEntity<Object> handleMissingServletRequestPart(final MissingServletRequestPartException ex,
		...
		System.out.println("Rhrough Advice: handleMissingServletRequestPart");
		logger.info(ex.getClass().getName());
		//
	...
	protected ResponseEntity<Object> handleMissingServletRequestParameter(
		...
		System.out.println("Rhrough Advice: handleMissingServletRequestParameter");
		logger.info(ex.getClass().getName());
		//
	...
	public ResponseEntity<Object> handleMethodArgumentTypeMismatch(final MethodArgumentTypeMismatchException ex,
			final WebRequest request) {
		System.out.println("Rhrough Advice: handleMethodArgumentTypeMismatch");
		logger.info(ex.getClass().getName());
	...
	public ResponseEntity<Object> handleConstraintViolation(final ConstraintViolationException ex,
			final WebRequest request) {
		System.out.println("Rhrough Advice: handleConstraintViolation");
		logger.info(ex.getClass().getName());
		//
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(final NoHandlerFoundException ex,
			final HttpHeaders headers, final HttpStatus status, final WebRequest request) {
		System.out.println("Rhrough Advice: handleNoHandlerFoundException");
		logger.info(ex.getClass().getName());
		//
	...
	protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(
			...
			final WebRequest request) {
		System.out.println("Rhrough Advice: handleHttpRequestMethodNotSupported");
		logger.info(ex.getClass().getName());
		//
	...
	protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(final HttpMediaTypeNotSupportedException ex,
			final HttpHeaders headers, final HttpStatus status, final WebRequest request) {
		System.out.println("Rhrough Advice: handleHttpMediaTypeNotSupported");
		logger.info(ex.getClass().getName());
		//
		final StringBuilder builder = new StringBuilder();
	...
	public ResponseEntity<Object> handleAll(final Exception ex, final WebRequest request) {
		System.out.println("Rhrough Advice: handleAll");
		logger.info(ex.getClass().getName());
