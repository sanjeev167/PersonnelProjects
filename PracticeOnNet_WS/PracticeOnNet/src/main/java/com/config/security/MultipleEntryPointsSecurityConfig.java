...
public class MultipleEntryPointsSecurityConfig {
	...
	@Bean
	public RoleHierarchy roleHierarchy() throws CustomRuntimeException {
	...
	@Bean
	public SecurityExpressionHandler<FilterInvocation> roleHierarchyExpressionHandler() throws CustomRuntimeException {
	...
	public class LocalAdministrativeWebChannel extends WebSecurityConfigurerAdapter {
		...
		protected void configure(AuthenticationManagerBuilder auth) throws Exception {
			//auth.userDetailsService(customAdministrativeUserDetailsServiceInMemory());// Through in memory
			 auth.userDetailsService(customAdministrativeUserDetailsService);// Through DAO
		}	
		
		@Override
		public void configure(WebSecurity web) throws Exception {
		    web.ignoring().antMatchers("/","/ce/*", "/admin/pub/*", "/resources/**");//Ignore from security
		}		
		...
		// http.requiresChannel().anyRequest().requiresSecure();//Redirect to https
		 ...
		 http.authorizeRequests()           
           ...
           // .anyRequest().denyAll()//This will restrict all the request except the authorized role             
		.and()
        	.formLogin()
        ...
        .and()
             .exceptionHandling()
             .accessDeniedPage("/ce/accessDeniedException")            
