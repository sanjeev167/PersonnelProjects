...
@Controller
@RequestMapping(value = "/admin/pvt/sec/env/department/")
public class DepartmentMasterController extends BaseController {
	...
	public String listDepartment(Model model) {		
		...
		String target = "/admin/pvt/sec/env/dept_master";		
	...
	public String departmentList(HttpServletRequest request, HttpServletResponse response) {
		...
		JsonResponse jsonResponse = new JsonResponse();
		try {
			List<NameValue> departmentList = departmentService.getDepartmentList();
