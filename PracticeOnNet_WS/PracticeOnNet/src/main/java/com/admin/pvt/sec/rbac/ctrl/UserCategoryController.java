...
import com.admin.pvt.sec.rbac.service.UserCategoryService;
...
@Controller
@RequestMapping(value = "/admin/pvt/sec/rbac/userCategory/")
public class UserCategoryController extends BaseController {
	...
	public String listUserCategory(Model model) {
		...
		String target = "/admin/pvt/sec/rbac/userCategory";
	...
	public String userCategoryList(@RequestParam Integer id, HttpServletRequest request, HttpServletResponse response) {
		...
		JsonResponse jsonResponse = new JsonResponse();
		try {
			List<NameValue> userCategoryList = userCategoryService.getUserCategoryList(id);
