 ...
 */
@Controller
@RequestMapping(value = "/admin/pvt/sec/rbac/webUser/")
public class WebUserAccountController extends BaseController {
	static final Logger log = LoggerFactory.getLogger(WebUserAccountController.class);
	...
	public String listUserAccounts(Model model) {
		log.info("WebUserAccountController :==> listUserAccounts :==> Started");
		String target = "/admin/pvt/sec/rbac/webUser";
		log.info("WebUserAccountController :==> listUserAccounts :==> Ended");
		return target;
	}
	...
	public String listUserAccountPaginated(HttpServletRequest request, HttpServletResponse response,
		...
		log.info("WebUserAccountController :==> listUserAccountPaginated :==> Started");
		...
		log.info("WebUserAccountController :==> listUserAccountPaginated :==> Ended");
	...
	public String getRecord(@RequestParam Long id, HttpServletRequest request, HttpServletResponse response) {
		log.info("WebUserAccountController :==> getRecord :==> Started");
	...
	public String saveAndUpdateRecord(@RequestBody @Valid WebUserDTO webUserDTO, BindingResult result,
		...
		log.info("WebUserAccountController :==> saveAndUpdateRecord :==> Started");
		JsonResponse jsonResponse = new JsonResponse();
		...
		log.info("WebUserAccountController :==> saveAndUpdateRecord :==> Ended");
		return new Gson().toJson(jsonResponse);
	}
	...
	public String deleteRecordById(@RequestParam Long id, HttpServletRequest request, HttpServletResponse response) {
		log.info("WebUserAccountController :==> deleteRecordById :==> Started");
		JsonResponse jsonResponse = new JsonResponse();
		try {
		...
		log.info("WebUserAccountController :==> deleteRecordById :==> Ended");
		return new Gson().toJson(jsonResponse);
	...
	public String deleteSelectedRecords(@RequestBody Long[] recordIdArray, HttpServletRequest request,
		...
		log.info("WebUserAccountController :==> deleteSelectedRecords :==> Started");
		JsonResponse jsonResponse = new JsonResponse();
		try {
		...
		log.info("WebUserAccountController :==> deleteSelectedRecords :==> Ended");
		return new Gson().toJson(jsonResponse);
	...
	public String userAccountList(@RequestParam Long id, HttpServletRequest request, HttpServletResponse response) {
		log.info("WebUserAccountController :==> userAccountList :==> Started");
		JsonResponse jsonResponse = new JsonResponse();
		try {
			List<NameValue> appAdminUserList = webUserAccountService.getWebUserList(id);
		...
		log.info("WebUserAccountController :==> userAccountList :==> Ended");
		return new Gson().toJson(jsonResponse);
	}
